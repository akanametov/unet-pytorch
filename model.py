...
class ExpandingBlock(nn.Module):
    ...
    def __init__(self, hid_channels):
        ...
        self.conv = nn.Conv2d(hid_channels, hid_channels//2, kernel_size=3, stride=1, padding=1)
        
        self.conv3x3_0 = nn.Conv2d(hid_channels, hid_channels//2, kernel_size=3, stride=1)
        self.conv3x3_1 = nn.Conv2d(hid_channels//2, hid_channels//2, kernel_size=3, stride=1)
